"""Calcula el consumo reciente de bebidas azucaradas entre jóvenes."""
...
def calcular():
    datos = cargar_individuales({CONSUMO: "ms05_0503_B"}, {CONSUMO: "vs01_0131_B"})
    return estimar_porcentaje(
        datos,
        caso=lambda d: d[CONSUMO].eq(1),
        valido=lambda d: d[CONSUMO].isin([1, 2]),
