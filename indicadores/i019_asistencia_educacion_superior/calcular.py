"""Calcula la asistencia a educación superior entre los 17 y 24 años."""
...
def calcular():
    datos = cargar_personas([VARIABLE]).loc[lambda d: d["edad"].between(17, 24)]
    return calcular_porcentaje(
        datos,
        caso=lambda d: d[VARIABLE].isin([6, 7]),
