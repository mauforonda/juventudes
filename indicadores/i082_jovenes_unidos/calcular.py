"""Calcula la proporción de jóvenes casados o convivientes."""
...
def calcular():
    datos = cargar_personas([ESTADO_CONYUGAL])
    return calcular_porcentaje(
        datos,
        caso=lambda d: d[ESTADO_CONYUGAL].isin([1, 2]),
        valido=lambda d: d[ESTADO_CONYUGAL].between(1, 6),
