"""Calcula la cobertura de seguro de salud entre jóvenes."""
...
def calcular():
    datos = cargar_personas([AFILIACION])
    return calcular_porcentaje(
        datos,
        caso=lambda d: d[AFILIACION].eq(1),
        valido=lambda d: d[AFILIACION].isin([1, 2]),
