"""Calcula el embarazo no planeado o forzado."""
...
def calcular():
    return estimar_porcentaje(
        cargar_mujeres({RESPUESTA: "ms02_0237"}),
        caso=lambda d: d[RESPUESTA].isin([2, 3, 4]),
        valido=lambda d: d[RESPUESTA].isin([1, 2, 3, 4]),
