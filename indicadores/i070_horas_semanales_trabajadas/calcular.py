"""Calcula la media y mediana de horas semanales trabajadas."""
...
def calcular():
    datos = cargar_personas([CONDICION_ACTIVIDAD, HORAS]).loc[
        lambda d: d[CONDICION_ACTIVIDAD].eq(1) & d[HORAS].between(1, 168)
    ]
    return pd.concat(
        [
            estimar_media(
                datos, variable=HORAS, dimensiones=DIMENSIONES_JOVENES, gestion=GESTION
