"""Calcula la violencia psicológica de pareja en los últimos 12 meses."""
...
ACTOS = [f"acto_{letra}" for letra in "ABCDEFGHIJK"]
COLUMNAS_RESULTADO = [
    "gestion",
    *DIMENSIONES_JOVENES,
    "observaciones",
...
def calcular():
    datos = cargar_individuales(
        {f"acto_{letra}": f"ms11_1105_{letra}" for letra in "ABCDEFGHIJK"},
        {f"acto_{letra}": f"vs08_0805_{letra}" for letra in "ABCDEFGHIJK"},
    )
