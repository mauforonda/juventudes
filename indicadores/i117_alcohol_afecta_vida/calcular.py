"""Calcula el consumo de alcohol que interfiere con la vida diaria."""
...
RESPUESTAS = [f"interferencia_{letra.lower()}" for letra in "ABCDX"]
MAPA_MUJER = dict(zip(RESPUESTAS, [f"ms10_1028_{letra}" for letra in "ABCDX"]))
MAPA_HOMBRE = dict(zip(RESPUESTAS, [f"vs01_0139_{letra}" for letra in "ABCDX"]))
COLUMNAS_RESULTADO = [
    "gestion",
    *DIMENSIONES_JOVENES,
    "observaciones",
