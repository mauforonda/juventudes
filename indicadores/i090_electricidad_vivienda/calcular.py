"""Calcula el acceso juvenil a electricidad en la vivienda."""
...
def calcular():
    datos = cargar_personas(columnas_vivienda=[ENERGIA])
    return calcular_porcentaje(
        datos,
        caso=lambda d: d[ENERGIA].isin([1, 2, 3, 4]),
        valido=lambda d: d[ENERGIA].between(1, 5),
