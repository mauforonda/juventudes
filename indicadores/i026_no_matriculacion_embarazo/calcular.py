"""Calcula el embarazo como razón de no matriculación."""
...
def calcular():
    datos = cargar_personas([MATRICULA, RAZON]).loc[
        lambda d: d[MATRICULA].eq(2) & d["sexo"].eq("mujer")
    ]
    return estimar_porcentaje(
        datos,
        caso=lambda d: d[RAZON].eq(3),
