"""Calcula la antigüedad de jóvenes en su ocupación actual."""
...
TIEMPO = "s04b_11ba"
UNIDAD_TIEMPO = "s04b_11bb"
CATEGORIA = "antiguedad_ocupacion"
COLUMNAS_RESULTADO = [
    "gestion",
    *DIMENSIONES_JOVENES,
    CATEGORIA,
...
def calcular():
    datos = cargar_personas([TIEMPO, UNIDAD_TIEMPO]).assign(
        ...
        antiguedad_ocupacion=lambda d: clasificar_duracion(d["duracion_meses"]),
    )
