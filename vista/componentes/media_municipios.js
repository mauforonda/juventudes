...
export async function render({ rows, campo, observaciones, estadistico, filtroCampo = "estadistico", filtroValor, version = "" }) {
  ...
  return crearMapa({ rows, campo, observaciones, estadistico, filtroCampo, filtroValor, geojson, nombres, campoCodigo: "codigo_municipio", normalizar, etiqueta: "por municipio", clase: "media_municipios", modo: "media" });
}
